...
public final class Utils {
	...
	public static void prepareData(Context context) {
		...
		chapter.setChaperName("Chapter 1: Overview");
		...
		chapter.setChaperName("Chapter 2: Material Quality");
		...
		// chapter 3
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 3: Question Quality");
		...
		// chapter 4
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 4: Understanding Your Score");
		...
		// chapter 5
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 5: Problem Solving");
		...
		// chapter 6
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 6: Data Sufficiency");
		...
		// chapter 7
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 7: Reading Comprehension");
		...
		// chapter 8
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 8: Critical Reasoning");
		...
		// chapter 9
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 9: Sentence Correction");
		...
		// chapter 10
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 10: Math Notes");
		...
		// chapter 11
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 11: Reading Comprehension Notes");
		...
		// chapter 12
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 12: Critical Reasoning Notes");
		...
		// chapter 13
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 13: Sentence Correction Notes");
		...
		// chapter 14
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 14: The 700 barrier");
		...
		// chapter 15
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 15: The 750 barrier");
		...
		// chapter 16
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 16: Study Tips");
		...
		// chapter 17
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 17: Exam day tips");
		...
		// chapter 18
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 18: The Greatest Feeling");
		...
		// chapter 19
		chapter = new ChapterEntity();
		chapter.setChaperName("Chapter 19: Thank you");
